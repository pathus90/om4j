...
/**
 * Utility class for constructing URLs for the Orange Money API based on different environments.
 *
 * <p>
 * This class provides static methods to generate URLs for various Orange Money API endpoints,
 * such as token retrieval, web payment, and transaction status, using the specified environment.
 * </p>
 *
 * <p>
 * Usage:
 ...
 *   <li>Use {@link #getWebPaymentUrl(String)} to construct the web payment URL based on the environment.</li>
 *   <li>Use {@link #getTransactionStatusUrl(String)} to create the transaction status URL based on the environment.</li>
 * </ul>
 * </p>
 */
public final class OrangeMoneyUrlBuilder {
     ...
     *
     * @param environment The environment (e.g., "dev", "test", "prod").
     ...
     *
     * @param environment The environment (e.g., "dev", "test", "prod").
     * @param urlSuffix   The URL suffix to append to the base URL.
     ...
     *
     * @param path The path to be included in the URL.
