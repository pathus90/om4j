...
public interface MobileMoneyTransaction {
	 ...
	 * @throws Exception
	 *             If an error occurs while getting the access token.
	 */
	 ...
	 * @throws Exception
	 *             If an error occurs while initializing the payment.
	 */
	 ...
	 * @throws Exception
	 *             If an error occurs while getting the transaction status.
	 */
