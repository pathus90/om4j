...
public enum ResponseCode {
	...
	/**
	 * Checks if the provided HTTP status code exists in the list of successful HTTP
	 * status codes.
	 *
	 * @param code
	 *            The HTTP status code to check.
	 * @return {@code true} if the code exists in the list of successful HTTP status
	 *         codes; otherwise, {@code false}.
	 */
